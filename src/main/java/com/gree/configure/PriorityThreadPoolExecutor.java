...
public class PriorityThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public PriorityThreadPoolExecutor(int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,int initialCapacity) {
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, getWorkQueueInit(initialCapacity));
    }
    ...
    protected static PriorityBlockingQueue getWorkQueueInit(int initialCapacity) {
